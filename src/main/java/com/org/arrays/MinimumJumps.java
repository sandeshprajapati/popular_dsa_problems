...
public class MinimumJumps {
	 ...
	 * 
	 * Input: arr = [1, 4, 3, 2, 6, 7] Output: 2 Explanation: First we jump from the
	 * 1st to 2nd element and then jump to the last element.
	 */
	public static void main(String[] args) {
		int[] arr = { 1, 3, 5, 8, 9, 2, 6, 7, 6, 8, 9 };
		int jumps = MinimumJumps.minJumps(arr);
